...
in {
  ...
  services.smartd.deviceOpts = "-o on -s (S/../.././02|L/../../7/04)";
  ...
  services.xserver.synaptics.maxSpeed = "120";
  services.xserver.synaptics.minSpeed = "120";
#  services.xserver.synaptics.sensitivity = "200";
...
#    load-module module-tunnel-sink se
#  '';
